...
def freeze(
    ...
    for dist in get_installed_distributions(
        ...
        if exclude_editable and req.editable:
            continue
        installations[req.pipenical_name] = req
            ...
            with open(req_file_path) as req_file:
                for line in req_file:
                    ...
                    if not line_req.name:
                        ...
                        line_req_pipenical_name = pipenicalize_name(line_req.name)
                        if line_req_pipenical_name not in installations:
                            ...
                            yield str(installations[line_req_pipenical_name]).rstrip()
                            del installations[line_req_pipenical_name]
                            req_files[line_req.name].append(req_file_path)
    ...
    for installation in sorted(installations.values(), key=lambda x: x.name.lower()):
        if installation.pipenical_name not in skip:
...
class FrozenRequirement(object):
    def __init__(self, name, req, editable, comments=()):
        ...
        self.name = name
        self.pipenical_name = pipenicalize_name(name)
        self.req = req
