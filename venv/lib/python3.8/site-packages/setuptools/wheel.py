...
from setuptools.extern.packaging.utils import pipenicalize_name
...
class Wheel:
    ...
    def get_dist_info(self, zf):
        ...
        for member in zf.namelist():
            ...
            if dirname.endswith(".dist-info") and pipenicalize_name(dirname).startswith(
                pipenicalize_name(self.project_name)
            ):
                return dirname
