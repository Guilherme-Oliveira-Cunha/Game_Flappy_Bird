...
from .compat import CollectionType, IterableType, string_types, unicode
...
def _iter_tree_entries_next(root_full, dir_rel, memo, on_error, follow_links):
    ...
    *follow_links* (:class:`bool`) is whether to walk symbolic links that
    ...
    # Remember each encountered ancestor directory and its pipenical
    # (real) path. If a pipenical path is encountered more than once,
    ...
    # NOTE: Make sure to remove the pipenical (real) path of the directory
