...
<head>
  ...
  <title>pygame.joystick &#8212; pygame v2.1.2 documentation</title>
    ...
    <div class="documentwrapper">
      <div class="body" role="main">
        ...
        <section id="module-pygame.joystick">
          <span id="pygame-joystick"></span>
          <dl class="definition">
            <dt class="title module sig sig-object">
              <code class="docutils literal notranslate"><span class="pre">pygame.joystick</span></code>
            </dt>
            <dd>
              <div class="line-block">
                <div class="line"><span class="summaryline">Pygame module for interacting with joysticks, gamepads, and
                    trackballs.</span></div>
              </div>
              <table class="toc docutils align-default">
                ...
                <tbody>
                  <tr class="row-odd">
                    <td>
                      <div class="line"><a class="toc reference external"
                          href="joystick.html#pygame.joystick.init">pygame.joystick.init</a></div>
                    </td>
                    <td>—</td>
                  ...
                  <tr class="row-even">
                    <td>
                      <div class="line"><a class="toc reference external"
                          href="joystick.html#pygame.joystick.quit">pygame.joystick.quit</a></div>
                    </td>
                    <td>—</td>
                  ...
                  <tr class="row-odd">
                    <td>
                      <div class="line"><a class="toc reference external"
                          href="joystick.html#pygame.joystick.get_init">pygame.joystick.get_init</a></div>
                    </td>
                    <td>—</td>
                  ...
                  <tr class="row-even">
                    <td>
                      <div class="line"><a class="toc reference external"
                          href="joystick.html#pygame.joystick.get_count">pygame.joystick.get_count</a></div>
                    </td>
                    <td>—</td>
                  ...
                  <tr class="row-odd">
                    <td>
                      <div class="line"><a class="toc reference external"
                          href="joystick.html#pygame.joystick.Joystick">pygame.joystick.Joystick</a></div>
                    </td>
                    <td>—</td>
              ...
              <div class="highlight-default notranslate">
                <div class="highlight">
                  <pre><span></span><span class="n">pygame</span><span class="o">.</span><span class="n">joystick</span><span class="o">.</span><span class="n">init</span><span class="p">()</span>
<span class="n">joysticks</span> <span class="o">=</span> <span class="p">[</span><span class="n">pygame</span><span class="o">.</span><span class="n">joystick</span><span class="o">.</span><span class="n">Joystick</span><span class="p">(</span><span class="n">x</span><span class="p">)</span> <span class="k">for</span> <span class="n">x</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">pygame</span><span class="o">.</span><span class="n">joystick</span><span class="o">.</span><span class="n">get_count</span><span class="p">())]</span>
              ...
              <div class="highlight-default notranslate">
                <div class="highlight">
                  <pre><span></span><span class="n">JOYAXISMOTION</span> <span class="n">JOYBALLMOTION</span> <span class="n">JOYBUTTONDOWN</span> <span class="n">JOYBUTTONUP</span> <span class="n">JOYHATMOTION</span>
</pre>
                </div>
              </div>
              ...
              <div class="highlight-default notranslate">
                <div class="highlight">
                  <pre><span></span><span class="n">JOYDEVICEADDED</span> <span class="n">JOYDEVICEREMOVED</span>
</pre>
                </div>
              </div>
              <p>Note that in pygame 2, joysticks events use a unique &quot;instance ID&quot;. The device index
                ...
                been added and removed. You must call <a class="reference internal"
                  href="#pygame.joystick.Joystick.get_instance_id"
                  title="pygame.joystick.Joystick.get_instance_id"><code
                    class="xref py py-meth docutils literal notranslate"><span class="pre">Joystick.get_instance_id()</span></code></a>
                to find
              ...
              <dl class="py function definition">
                <dt class="sig sig-object py title" id="pygame.joystick.init">
                  <span class="sig-prename descclassname"><span class="pre">pygame.joystick.</span></span><span
                    class="sig-name descname"><span class="pre">init</span></span><span class="sig-paren">(</span><span
                    class="sig-paren">)</span><a class="headerlink" href="#pygame.joystick.init"
                ...
                <dd>
                  ...
                  <p>This function is called automatically by <code
                      class="docutils literal notranslate"><span class="pre">pygame.init()</span></code>.</p>
              ...
              <dl class="py function definition">
                <dt class="sig sig-object py title" id="pygame.joystick.quit">
                  <span class="sig-prename descclassname"><span class="pre">pygame.joystick.</span></span><span
                    class="sig-name descname"><span class="pre">quit</span></span><span class="sig-paren">(</span><span
                    class="sig-paren">)</span><a class="headerlink" href="#pygame.joystick.quit"
                    title="Permalink to this definition">¶</a>
                </dt>
                <dd>
                  <div class="line-block">
              ...
              <dl class="py function definition">
                <dt class="sig sig-object py title" id="pygame.joystick.get_init">
                  <span class="sig-prename descclassname"><span class="pre">pygame.joystick.</span></span><span
                    class="sig-name descname"><span class="pre">get_init</span></span><span
                    class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                    href="#pygame.joystick.get_init" title="Permalink to this definition">¶</a>
                </dt>
                <dd>
                  <div class="line-block">
                    <div class="line"><span class="summaryline">Returns True if the joystick module is
                        initialized.</span></div>
                    <div class="line"><span class="signature">get_init() -&gt; bool</span></div>
                  </div>
                  <p>Test if the <code
                      class="docutils literal notranslate"><span class="pre">pygame.joystick.init()</span></code>
              ...
              <dl class="py function definition">
                <dt class="sig sig-object py title" id="pygame.joystick.get_count">
                  <span class="sig-prename descclassname"><span class="pre">pygame.joystick.</span></span><span
                    class="sig-name descname"><span class="pre">get_count</span></span><span
                    class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                    href="#pygame.joystick.get_count" title="Permalink to this definition">¶</a>
                </dt>
                <dd>
                  <div class="line-block">
                  ...
                  <p>Return the number of joystick devices on the system. The count will be <code
                      class="docutils literal notranslate"><span class="pre">0</span></code>
                    if there are no joysticks on the system.</p>
                  <p>When you create Joystick objects using <code
                      class="docutils literal notranslate"><span class="pre">Joystick(id)</span></code>, you pass an
                    integer
              ...
              <dl class="py class definition">
                <dt class="sig sig-object py title" id="pygame.joystick.Joystick">
                  <span class="sig-prename descclassname"><span class="pre">pygame.joystick.</span></span><span
                    class="sig-name descname"><span class="pre">Joystick</span></span><a class="headerlink"
                    href="#pygame.joystick.Joystick" title="Permalink to this definition">¶</a>
                </dt>
                <dd>
                  <div class="line-block">
                  ...
                  <table class="toc docutils align-default">
                    ...
                    <tbody>
                      <tr class="row-odd">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.init">pygame.joystick.Joystick.init</a></div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-even">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.quit">pygame.joystick.Joystick.quit</a></div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-odd">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_init">pygame.joystick.Joystick.get_init</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-even">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_id">pygame.joystick.Joystick.get_id</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-odd">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_instance_id">pygame.joystick.Joystick.get_instance_id</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-even">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_guid">pygame.joystick.Joystick.get_guid</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-odd">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_power_level">pygame.joystick.Joystick.get_power_level</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-even">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_name">pygame.joystick.Joystick.get_name</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-odd">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_numaxes">pygame.joystick.Joystick.get_numaxes</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-even">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_axis">pygame.joystick.Joystick.get_axis</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-odd">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_numballs">pygame.joystick.Joystick.get_numballs</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-even">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_ball">pygame.joystick.Joystick.get_ball</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-odd">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_numbuttons">pygame.joystick.Joystick.get_numbuttons</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-even">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_button">pygame.joystick.Joystick.get_button</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-odd">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_numhats">pygame.joystick.Joystick.get_numhats</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-even">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.get_hat">pygame.joystick.Joystick.get_hat</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-odd">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.rumble">pygame.joystick.Joystick.rumble</a>
                          </div>
                        </td>
                        <td>—</td>
                      ...
                      <tr class="row-even">
                        <td>
                          <div class="line"><a class="toc reference external"
                              href="joystick.html#pygame.joystick.Joystick.stop_rumble">pygame.joystick.Joystick.stop_rumble</a>
                          </div>
                        </td>
                        <td>—</td>
                  ...
                  <p>Create a new joystick to access a physical device. The id argument must be a
                    value from <code class="docutils literal notranslate"><span class="pre">0</span></code> to <code
                      class="docutils literal notranslate"><span class="pre">pygame.joystick.get_count()</span> <span class="pre">-</span> <span class="pre">1</span></code>.
                  </p>
                  ...
                  <div class="versionchanged">
                    <p><span class="versionmodified changed">Changed in pygame 2.0.0: </span>Joystick objects are now
                      opened immediately on creation.</p>
                  </div>
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.init">
                      <span class="sig-name descname"><span class="pre">init</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.init" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                      ...
                      <div class="deprecated">
                        <p><span class="versionmodified deprecated">Deprecated since pygame 2.0.0: </span>In future it
                          will not be possible to reinitialise a closed Joystick
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.quit">
                      <span class="sig-name descname"><span class="pre">quit</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.quit" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_init">
                      <span class="sig-name descname"><span class="pre">get_init</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_init" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_id">
                      <span class="sig-name descname"><span class="pre">get_id</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_id" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                      ...
                      <p>Returns the original device index for this device. This is the same
                        value that was passed to the <code
                          class="docutils literal notranslate"><span class="pre">Joystick()</span></code> constructor.
                        This method can
                        safely be called while the Joystick is not initialized.</p>
                      <div class="deprecated">
                        <p><span class="versionmodified deprecated">Deprecated since pygame 2.0.0: </span>The original
                          device index is not useful in pygame 2. Use
                          <a class="reference internal" href="#pygame.joystick.Joystick.get_instance_id"
                            title="pygame.joystick.Joystick.get_instance_id"><code
                              class="xref py py-meth docutils literal notranslate"><span class="pre">get_instance_id()</span></code></a>
                          instead. Will be removed in Pygame 2.1.
                        </p>
                      </div>
                    </dd>
                  </dl>
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_instance_id">
                      <span class="sig-name descname"><span class="pre">get_instance_id</span></span><span
                        ...
                        href="#pygame.joystick.Joystick.get_instance_id" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                      ...
                      <p>Get the joystick instance ID. This matches the <code
                          class="docutils literal notranslate"><span class="pre">instance_id</span></code> field
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_guid">
                      <span class="sig-name descname"><span class="pre">get_guid</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span> <span class="sig-return"><span
                          class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span
                            class="pre">str</span></span></span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_guid" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_power_level">
                      <span class="sig-name descname"><span class="pre">get_power_level</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span> <span class="sig-return"><span
                          class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span
                            class="pre">str</span></span></span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_power_level" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                        <div class="line"><span class="summaryline">get the approximate power status of the
                            device</span></div>
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_name">
                      <span class="sig-name descname"><span class="pre">get_name</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_name" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_numaxes">
                      <span class="sig-name descname"><span class="pre">get_numaxes</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_numaxes" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                      ...
                      <p>Returns the number of input axes are on a Joystick. There will usually be
                        ...
                        additional axes.</p>
                      <p>The <code
                          class="docutils literal notranslate"><span class="pre">pygame.JOYAXISMOTION</span></code>
                        events will be in the range from <code
                          class="docutils literal notranslate"><span class="pre">-1.0</span></code>
                        to <code class="docutils literal notranslate"><span class="pre">1.0</span></code>. A value of
                        <code class="docutils literal notranslate"><span class="pre">0.0</span></code> means the axis is
                        centered. Gamepad devices
                        will usually be <code class="docutils literal notranslate"><span class="pre">-1</span></code>,
                        <code class="docutils literal notranslate"><span class="pre">0</span></code>, or <code
                          class="docutils literal notranslate"><span class="pre">1</span></code> with no values in
                        between. Older
                        analog joystick axes will not always use the full <code
                          class="docutils literal notranslate"><span class="pre">-1</span></code> to <code
                          class="docutils literal notranslate"><span class="pre">1</span></code> range,
                        and the centered value will be some area around <code
                          class="docutils literal notranslate"><span class="pre">0</span></code>.</p>
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_axis">
                      <span class="sig-name descname"><span class="pre">get_axis</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_axis" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                      ...
                      <p>Returns the current position of a joystick axis. The value will range
                        from <code class="docutils literal notranslate"><span class="pre">-1</span></code> to <code
                          class="docutils literal notranslate"><span class="pre">1</span></code> with a value of <code
                          class="docutils literal notranslate"><span class="pre">0</span></code> being centered. You may
                        want
                        to take into account some tolerance to handle jitter, and joystick drift
                        may keep the joystick from centering at <code
                          class="docutils literal notranslate"><span class="pre">0</span></code> or using the full range
                        of
                        position values.</p>
                      <p>The axis number must be an integer from <code
                          class="docutils literal notranslate"><span class="pre">0</span></code> to <code
                          class="docutils literal notranslate"><span class="pre">get_numaxes()</span> <span class="pre">-</span> <span class="pre">1</span></code>.
                      </p>
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_numballs">
                      <span class="sig-name descname"><span class="pre">get_numballs</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_numballs" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                        <div class="line"><span class="summaryline">get the number of trackballs on a Joystick</span>
                        </div>
                      ...
                      <p>The <code
                          class="docutils literal notranslate"><span class="pre">pygame.JOYBALLMOTION</span></code>
                        event will be sent when the trackball is
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_ball">
                      <span class="sig-name descname"><span class="pre">get_ball</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_ball" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                        <div class="line"><span class="summaryline">get the relative position of a trackball</span>
                        </div>
                        <div class="line"><span class="signature">get_ball(ball_number) -&gt; x, y</span></div>
                      </div>
                      <p>Returns the relative movement of a joystick button. The value is a <code
                          class="docutils literal notranslate"><span class="pre">x,</span> <span class="pre">y</span></code>
                        pair holding the relative movement since the last call to get_ball.</p>
                      <p>The ball number must be an integer from <code
                          class="docutils literal notranslate"><span class="pre">0</span></code> to <code
                          class="docutils literal notranslate"><span class="pre">get_numballs()</span> <span class="pre">-</span> <span class="pre">1</span></code>.
                      </p>
                    </dd>
                  </dl>
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_numbuttons">
                      <span class="sig-name descname"><span class="pre">get_numbuttons</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_numbuttons" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                      ...
                      <p>Buttons generate a <code
                          class="docutils literal notranslate"><span class="pre">pygame.JOYBUTTONDOWN</span></code> and
                        <code class="docutils literal notranslate"><span class="pre">pygame.JOYBUTTONUP</span></code>
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_button">
                      <span class="sig-name descname"><span class="pre">get_button</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_button" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_numhats">
                      <span class="sig-name descname"><span class="pre">get_numhats</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_numhats" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                        <div class="line"><span class="summaryline">get the number of hat controls on a Joystick</span>
                        </div>
                      ...
                      <p>Returns the number of joystick hats on a Joystick. Hat devices are like
                        ...
                        input.</p>
                      <p>The <code
                          class="docutils literal notranslate"><span class="pre">pygame.JOYHATMOTION</span></code> event
                        is generated when the hat changes
                        position. The <code
                          class="docutils literal notranslate"><span class="pre">position</span></code> attribute for
                        the event contains a pair of
                        values that are either <code
                          class="docutils literal notranslate"><span class="pre">-1</span></code>, <code
                          class="docutils literal notranslate"><span class="pre">0</span></code>, or <code
                          class="docutils literal notranslate"><span class="pre">1</span></code>. A position of <code
                          class="docutils literal notranslate"><span class="pre">(0,</span> <span class="pre">0)</span></code>
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.get_hat">
                      <span class="sig-name descname"><span class="pre">get_hat</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.get_hat" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                      ...
                      <p>Returns the current position of a position hat. The position is given as
                        two values representing the <code
                          class="docutils literal notranslate"><span class="pre">x</span></code> and <code
                          class="docutils literal notranslate"><span class="pre">y</span></code> position for the hat.
                        <code
                          class="docutils literal notranslate"><span class="pre">(0,</span> <span class="pre">0)</span></code>
                        means centered. A value of <code
                          class="docutils literal notranslate"><span class="pre">-1</span></code> means left/down and a
                        value of <code class="docutils literal notranslate"><span class="pre">1</span></code> means
                        right/up: so <code
                          class="docutils literal notranslate"><span class="pre">(-1,</span> <span class="pre">0)</span></code>
                        means left; <code
                          class="docutils literal notranslate"><span class="pre">(1,</span> <span class="pre">0)</span></code>
                        means right; <code
                          class="docutils literal notranslate"><span class="pre">(0,</span> <span class="pre">1)</span></code>
                        means
                        up; <code
                          class="docutils literal notranslate"><span class="pre">(1,</span> <span class="pre">1)</span></code>
                        means upper-right; etc.</p>
                      <p>This value is digital, <code
                          class="docutils literal notranslate"><span class="pre">i.e.</span></code>, each coordinate can
                      ...
                      <p>The hat number must be between <code
                          class="docutils literal notranslate"><span class="pre">0</span></code> and <code
                          class="docutils literal notranslate"><span class="pre">get_numhats()</span> <span class="pre">-</span> <span class="pre">1</span></code>.
                      </p>
                    </dd>
                  </dl>
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.rumble">
                      <span class="sig-name descname"><span class="pre">rumble</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.rumble" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                        <div class="line"><span class="summaryline">Start a rumbling effect</span></div>
                        <div class="line"><span class="signature">rumble(low_frequency, high_frequency, duration) -&gt;
                            bool</span></div>
                      </div>
                      <p>Start a rumble effect on the joystick, with the specified strength ranging
                        ...
                        <a class="reference internal" href="#pygame.joystick.Joystick.stop_rumble"
                          title="pygame.joystick.Joystick.stop_rumble"><code
                            class="xref py py-meth docutils literal notranslate"><span class="pre">Joystick.stop_rumble()</span></code></a>
                        is called. If an effect is already
                        playing, then it will be overwritten.
                      </p>
                      <p>Returns True if the rumble was played successfully or False if the
                        joystick does not support it or <a class="tooltip reference internal"
                          href="pygame.html#pygame.version.SDL" title=""><code
                            class="xref py py-meth docutils literal notranslate"><span class="pre">pygame.version.SDL()</span></code><span
                            class="tooltip-content">tupled integers of the SDL library version</span></a> is below
                        2.0.9.</p>
                      <div class="versionadded">
                  ...
                  <dl class="py method definition">
                    <dt class="sig sig-object py title" id="pygame.joystick.Joystick.stop_rumble">
                      <span class="sig-name descname"><span class="pre">stop_rumble</span></span><span
                        class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink"
                        href="#pygame.joystick.Joystick.stop_rumble" title="Permalink to this definition">¶</a>
                    </dt>
                    <dd>
                      <div class="line-block">
                      ...
                      <p>Stops any rumble effect playing on the joystick. See
                        <a class="reference internal" href="#pygame.joystick.Joystick.rumble"
                          title="pygame.joystick.Joystick.rumble"><code
                            class="xref py py-meth docutils literal notranslate"><span class="pre">Joystick.rumble()</span></code></a>
              ...
              <figure class="align-default" id="id1">
                <a class="reference internal image-reference" href="../_images/joystick_calls.png"><img
                    alt="joystick module example" src="../_images/joystick_calls.png"
                    style="width: 363.0px; height: 397.0px;" /></a>
                <figcaption>
                  <p><span class="caption-text">Example code for joystick module.</span><a class="headerlink"
...
<span class="c1"># Define some colors.</span>
<span class="n">BLACK</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">Color</span><span class="p">(</span><span class="s1">&#39;black&#39;</span><span class="p">)</span>
<span class="n">WHITE</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">Color</span><span class="p">(</span><span class="s1">&#39;white&#39;</span><span class="p">)</span>
...
<span class="k">class</span> <span class="nc">TextPrint</span><span class="p">(</span><span class="nb">object</span><span class="p">):</span>
    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">reset</span><span class="p">()</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">font</span> <span class="o">=</span> <span class="n">pygame</span><span class="o">.</span><span class="n">font</span><span class="o">.</span><span class="n">Font</span><span class="p">(</span><span class="kc">None</span><span class="p">,</span> <span class="mi">20</span><span class="p">)</span>

    <span class="k">def</span> <span class="nf">tprint</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">screen</span><span class="p">,</span> <span class="n">textString</span><span class="p">):</span>
        <span class="n">textBitmap</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">font</span><span class="o">.</span><span class="n">render</span><span class="p">(</span><span class="n">textString</span><span class="p">,</span> <span class="kc">True</span><span class="p">,</span> <span class="n">BLACK</span><span class="p">)</span>
        <span class="n">screen</span><span class="o">.</span><span class="n">blit</span><span class="p">(</span><span class="n">textBitmap</span><span class="p">,</span> <span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">x</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">y</span><span class="p">))</span>
...
<span class="c1"># Set the width and height of the screen (width, height).</span>
...
<span class="c1"># Initialize the joysticks.</span>
...
<span class="n">textPrint</span> <span class="o">=</span> <span class="n">TextPrint</span><span class="p">()</span>
...
<span class="k">while</span> <span class="ow">not</span> <span class="n">done</span><span class="p">:</span>
    ...
    <span class="c1">#</span>
    <span class="c1"># Possible joystick actions: JOYAXISMOTION, JOYBALLMOTION, JOYBUTTONDOWN,</span>
    <span class="c1"># JOYBUTTONUP, JOYHATMOTION</span>
    ...
    <span class="n">textPrint</span><span class="o">.</span><span class="n">reset</span><span class="p">()</span>
    ...
    <span class="n">textPrint</span><span class="o">.</span><span class="n">tprint</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;Number of joysticks: </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">joystick_count</span><span class="p">))</span>
    <span class="n">textPrint</span><span class="o">.</span><span class="n">indent</span><span class="p">()</span>
    ...
    <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">joystick_count</span><span class="p">):</span>
        ...
        <span class="k">except</span> <span class="ne">AttributeError</span><span class="p">:</span>
            <span class="c1"># get_instance_id() is an SDL2 method</span>
            <span class="n">jid</span> <span class="o">=</span> <span class="n">joystick</span><span class="o">.</span><span class="n">get_id</span><span class="p">()</span>
        <span class="n">textPrint</span><span class="o">.</span><span class="n">tprint</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;Joystick </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">jid</span><span class="p">))</span>
        <span class="n">textPrint</span><span class="o">.</span><span class="n">indent</span><span class="p">()</span>
        ...
        <span class="n">textPrint</span><span class="o">.</span><span class="n">tprint</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;Joystick name: </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">name</span><span class="p">))</span>
        ...
        <span class="k">except</span> <span class="ne">AttributeError</span><span class="p">:</span>
            <span class="c1"># get_guid() is an SDL2 method</span>
            <span class="k">pass</span>
        <span class="k">else</span><span class="p">:</span>
            <span class="n">textPrint</span><span class="o">.</span><span class="n">tprint</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;GUID: </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">guid</span><span class="p">))</span>
        ...
        <span class="n">textPrint</span><span class="o">.</span><span class="n">tprint</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;Number of axes: </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">axes</span><span class="p">))</span>
        <span class="n">textPrint</span><span class="o">.</span><span class="n">indent</span><span class="p">()</span>
        ...
        <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">axes</span><span class="p">):</span>
            ...
            <span class="n">textPrint</span><span class="o">.</span><span class="n">tprint</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;Axis </span><span class="si">{}</span><span class="s2"> value: </span><span class="si">{:&gt;6.3f}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">i</span><span class="p">,</span> <span class="n">axis</span><span class="p">))</span>
        <span class="n">textPrint</span><span class="o">.</span><span class="n">unindent</span><span class="p">()</span>
        ...
        <span class="n">textPrint</span><span class="o">.</span><span class="n">tprint</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;Number of buttons: </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">buttons</span><span class="p">))</span>
        <span class="n">textPrint</span><span class="o">.</span><span class="n">indent</span><span class="p">()</span>
        ...
        <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">buttons</span><span class="p">):</span>
            ...
            <span class="n">textPrint</span><span class="o">.</span><span class="n">tprint</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span>
                             <span class="s2">&quot;Button </span><span class="si">{:&gt;2}</span><span class="s2"> value: </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">i</span><span class="p">,</span> <span class="n">button</span><span class="p">))</span>
        <span class="n">textPrint</span><span class="o">.</span><span class="n">unindent</span><span class="p">()</span>
        ...
        <span class="n">textPrint</span><span class="o">.</span><span class="n">tprint</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;Number of hats: </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">hats</span><span class="p">))</span>
        <span class="n">textPrint</span><span class="o">.</span><span class="n">indent</span><span class="p">()</span>
        ...
        <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">hats</span><span class="p">):</span>
            ...
            <span class="n">textPrint</span><span class="o">.</span><span class="n">tprint</span><span class="p">(</span><span class="n">screen</span><span class="p">,</span> <span class="s2">&quot;Hat </span><span class="si">{}</span><span class="s2"> value: </span><span class="si">{}</span><span class="s2">&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">i</span><span class="p">,</span> <span class="nb">str</span><span class="p">(</span><span class="n">hat</span><span class="p">)))</span>
        <span class="n">textPrint</span><span class="o">.</span><span class="n">unindent</span><span class="p">()</span>

        <span class="n">textPrint</span><span class="o">.</span><span class="n">unindent</span><span class="p">()</span>

    <span class="c1">#</span>
    <span class="c1"># ALL CODE TO DRAW SHOULD GO ABOVE THIS COMMENT</span>
    <span class="c1">#</span>

    <span class="c1"># Go ahead and update the screen with what we&#39;ve drawn.</span>
    <span class="n">pygame</span><span class="o">.</span><span class="n">display</span><span class="o">.</span><span class="n">flip</span><span class="p">()</span>

    <span class="c1"># Limit to 20 frames per second.</span>
...
<span class="c1"># Close the window and quit.</span>
...
<span class="n">pygame</span><span class="o">.</span><span class="n">quit</span><span class="p">()</span>
              ...
              <p id="controller-mappings"><strong>Common Controller Axis Mappings</strong></p>
              <p>Controller mappings are drawn from the underlying SDL library which pygame uses and they differ
                between pygame 1 and pygame 2. Below are a couple of mappings for two pojump game pads.</p>
              <p><strong>Pygame 2</strong></p>
              <p>Axis and hat mappings are listed from -1 to +1.</p>
              <p><strong>X-Box 360 Controller (name: &quot;Xbox 360 Controller&quot;)</strong></p>
              <p>In pygame 2 the X360 controller mapping has 6 Axes, 11 buttons and 1 hat.</p>
              <ul>
                <li>
                  <p><strong>Left Stick</strong>:</p>
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">Left</span> <span class="o">-&gt;</span> <span class="n">Right</span>   <span class="o">-</span> <span class="n">Axis</span> <span class="mi">0</span>
<span class="n">Up</span>   <span class="o">-&gt;</span> <span class="n">Down</span>    <span class="o">-</span> <span class="n">Axis</span> <span class="mi">1</span>
                ...
                <li>
                  <p><strong>Right Stick</strong>:</p>
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">Left</span> <span class="o">-&gt;</span> <span class="n">Right</span>   <span class="o">-</span> <span class="n">Axis</span> <span class="mi">3</span>
<span class="n">Up</span>   <span class="o">-&gt;</span> <span class="n">Down</span>    <span class="o">-</span> <span class="n">Axis</span> <span class="mi">4</span>
                ...
                <li>
                  <p><strong>Left Trigger</strong>:</p>
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">Out</span> <span class="o">-&gt;</span> <span class="n">In</span>       <span class="o">-</span> <span class="n">Axis</span> <span class="mi">2</span>
</pre>
                    </div>
                  </div>
                </li>
                <li>
                  <p><strong>Right Trigger</strong>:</p>
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">Out</span> <span class="o">-&gt;</span> <span class="n">In</span>       <span class="o">-</span> <span class="n">Axis</span> <span class="mi">5</span>
</pre>
                    </div>
                  </div>
                </li>
                <li>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">A</span> <span class="n">Button</span>        <span class="o">-</span> <span class="n">Button</span> <span class="mi">0</span>
...
<span class="n">Guide</span> <span class="n">Button</span>    <span class="o">-</span> <span class="n">Button</span> <span class="mi">10</span>
                ...
                <li>
                  <p><strong>Hat/D-pad</strong>:</p>
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">Down</span> <span class="o">-&gt;</span> <span class="n">Up</span>      <span class="o">-</span> <span class="n">Y</span> <span class="n">Axis</span>
<span class="n">Left</span> <span class="o">-&gt;</span> <span class="n">Right</span>   <span class="o">-</span> <span class="n">X</span> <span class="n">Axis</span>
              ...
              <p><strong>Playstation 4 Controller (name: &quot;PS4 Controller&quot;)</strong></p>
              <p>In pygame 2 the PS4 controller mapping has 6 Axes and 16 buttons.</p>
              <ul>
                <li>
                  <p><strong>Left Stick</strong>:</p>
                  <div class="highlight-default notranslate">
...
<span class="n">Up</span>   <span class="o">-&gt;</span> <span class="n">Down</span>    <span class="o">-</span> <span class="n">Axis</span> <span class="mi">1</span>
                ...
                <li>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">Left</span> <span class="o">-&gt;</span> <span class="n">Right</span>   <span class="o">-</span> <span class="n">Axis</span> <span class="mi">2</span>
<span class="n">Up</span>   <span class="o">-&gt;</span> <span class="n">Down</span>    <span class="o">-</span> <span class="n">Axis</span> <span class="mi">3</span>
                ...
                <li>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">Out</span> <span class="o">-&gt;</span> <span class="n">In</span>       <span class="o">-</span> <span class="n">Axis</span> <span class="mi">4</span>
</pre>
                    </div>
                  </div>
                </li>
                ...
                <li>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">Cross</span> <span class="n">Button</span>    <span class="o">-</span> <span class="n">Button</span> <span class="mi">0</span>
...
<span class="n">Touch</span> <span class="n">Pad</span> <span class="n">Click</span> <span class="o">-</span> <span class="n">Button</span> <span class="mi">15</span>
              ...
              <p><strong>Pygame 1</strong></p>
              <p>Axis and hat mappings are listed from -1 to +1.</p>
              <p><strong>X-Box 360 Controller (name: &quot;Controller (XBOX 360 For Windows)&quot;)</strong></p>
              <p>In pygame 1 the X360 controller mapping has 5 Axes, 10 buttons and 1 hat.</p>
              <ul>
                <li>
                  <p><strong>Left Stick</strong>:</p>
                  <div class="highlight-default notranslate">
...
<span class="n">Up</span>   <span class="o">-&gt;</span> <span class="n">Down</span>    <span class="o">-</span> <span class="n">Axis</span> <span class="mi">1</span>
                ...
                <li>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">Left</span> <span class="o">-&gt;</span> <span class="n">Right</span>   <span class="o">-</span> <span class="n">Axis</span> <span class="mi">4</span>
<span class="n">Up</span>   <span class="o">-&gt;</span> <span class="n">Down</span>    <span class="o">-</span> <span class="n">Axis</span> <span class="mi">3</span>
</pre>
                    </div>
                  </div>
                ...
                <li>
                  <p><strong>Left Trigger &amp; Right Trigger</strong>:</p>
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">RT</span> <span class="o">-&gt;</span> <span class="n">LT</span>        <span class="o">-</span> <span class="n">Axis</span> <span class="mi">2</span>
</pre>
                    </div>
                  </div>
                </li>
...
<span class="n">Left</span> <span class="o">-&gt;</span> <span class="n">Right</span>   <span class="o">-</span> <span class="n">X</span> <span class="n">Axis</span>
              ...
              <p><strong>Playstation 4 Controller (name: &quot;Wireless Controller&quot;)</strong></p>
              <p>In pygame 1 the PS4 controller mapping has 6 Axes and 14 buttons and 1 hat.</p>
              <ul>
                <li>
                  <p><strong>Left Stick</strong>:</p>
                  <div class="highlight-default notranslate">
...
<span class="n">Left</span> <span class="o">-&gt;</span> <span class="n">Right</span>   <span class="o">-</span> <span class="n">X</span> <span class="n">Axis</span>
        ...
        <br /><br />
        <hr />
        <a href="https://github.com/pygame/pygame/edit/main/docs/reST/ref/joystick.rst" rel="nofollow">Edit on
          GitHub</a>
  ...
  <div class="related" role="navigation" aria-label="related navigation">
    ...
    <ul>
      ...
      <li class="right">
        <a href="key.html" title="pygame.key" accesskey="N">next</a> |
      </li>
      <li class="right">
        <a href="image.html" title="pygame.image" accesskey="P">previous</a> |
      </li>
      <li class="nav-item nav-item-0"><a href="../index.html">pygame v2.1.2 documentation</a> &#187;</li>
      <li class="nav-item nav-item-this"><a href=""><code
            class="xref py py-mod docutils literal notranslate"><span class="pre">pygame.joystick</span></code></a></li>
