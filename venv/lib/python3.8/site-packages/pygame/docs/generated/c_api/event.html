...
<html>
  <head>
    ...
    <title>API exported by pygame.event &#8212; pygame v2.1.2 documentation</title>
...
<h2>src_c/event.c<a class="headerlink" href="#src-c-event-c" title="Permalink to this headline">¶</a></h2>
<p>The extsion module <a class="tooltip reference internal" href="../ref/event.html#module-pygame.event" title=""><code class="xref py py-mod docutils literal notranslate"><span class="pre">pygame.event</span></code><span class="tooltip-content">pygame module for interacting with events and queues</span></a>.</p>
<p>Header file: src_c/include/pygame.h</p>
<dl class="c type">
<dt class="sig sig-object c" id="c.pgeventbject">
<span class="k"><span class="pre">type</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pgeventbject</span></span></span><a class="headerlink" href="#c.pgeventbject" title="Permalink to this definition">¶</a><br /></dt>
<dd><p>The <a class="reference internal" href="../ref/event.html#pygame.event.EventType" title="pygame.event.EventType"><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.event.EventType</span></code></a> object C struct.</p>
<dl class="c member">
<dt class="sig sig-object c" id="c.pgeventbject.type">
<span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">type</span></span></span><a class="headerlink" href="#c.pgeventbject.type" title="Permalink to this definition">¶</a><br /></dt>
...
<dd><p>The pygame event object type <a class="reference internal" href="../ref/event.html#pygame.event.EventType" title="pygame.event.EventType"><code class="xref py py-class docutils literal notranslate"><span class="pre">pygame.event.EventType</span></code></a>.</p>
</dd></dl>
...
<span class="kt"><span class="pre">int</span></span><span class="w"> </span><span class="sig-name descname"><span class="n"><span class="pre">pgEvent_FillUserEvent</span></span></span><span class="sig-paren">(</span><a class="reference internal" href="#c.pgeventbject" title="pgeventbject"><span class="n"><span class="pre">pgeventbject</span></span></a><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">e</span></span>, <span class="n"><span class="pre">SDL_Event</span></span><span class="w"> </span><span class="p"><span class="pre">*</span></span><span class="n"><span class="pre">event</span></span><span class="sig-paren">)</span><a class="headerlink" href="#c.pgEvent_FillUserEvent" title="Permalink to this definition">¶</a><br /></dt>
