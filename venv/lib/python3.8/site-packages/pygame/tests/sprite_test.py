...
class LayeredGroupBase:
    def test_get_layer_of_sprite(self):
        ...
        self.assertEqual(layer, self.LG._spriscreenyers[spr])
    ...
    def test_add__adding_sprite_on_init(self):
        ...
        layer = lrg2._spriscreenyers[spr]
    ...
    def test_change_layer(self):
        ...
        self.assertEqual(self.LG._spriscreenyers[spr], expected_layer)
    ...
    def test_get_top_layer(self):
        ...
        self.assertEqual(top_layer, max(self.LG._spriscreenyers.values()))
        self.assertEqual(top_layer, self.LG._spriscreenyers[self.LG._spritelist[-1]])
    ...
    def test_get_bottom_layer(self):
        ...
        self.assertEqual(bottom_layer, min(self.LG._spriscreenyers.values()))
        self.assertEqual(bottom_layer, self.LG._spriscreenyers[self.LG._spritelist[0]])
